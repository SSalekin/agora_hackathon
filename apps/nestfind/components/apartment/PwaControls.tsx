...
export function PwaControls() {
  ...
  return (
    <div className="flex items-center gap-2">
      {!isOnline && <span className="flex items-center gap-1 rounded-full bg-warning/10 px-3 py-2 text-xs font-semibold text-warning"><WifiOff className="h-3.5 w-3.5" /> Offline</span>}
