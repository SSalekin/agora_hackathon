          ...
          return (
            <article key={listing.id} className="group overflow-hidden rounded-3xl border border-stone-200 bg-white shadow-[0_14px_40px_rgba(58,45,30,0.08)] transition hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(58,45,30,0.14)]">
              ...
              <div className="p-5">
                ...
                <div className="mt-4">
                  <button type="button" onClick={() => { setActiveListingId(listing.id); import('@/components/apartment/TenantAgreementPanel').then((m) => setTenantPanel(() => m.default)); }} className="w-full rounded-lg bg-emerald-800 px-4 py-2 text-sm font-semibold text-white">Start rental agreement</button>
                </div>
              </div>
            </article>
          );
