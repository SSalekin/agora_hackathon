...
export function StakeBadge({ activeStakeSol, hasMinimumStake, disputesLost, size = 'sm' }: StakeBadgeProps) {
  ...
  return (
    <span className={`inline-flex items-center gap-1 rounded-full bg-emerald-50 px-2 py-0.5 text-[11px] font-semibold text-emerald-800 ${size === 'md' ? 'px-3 py-1 text-xs' : ''}`}>
