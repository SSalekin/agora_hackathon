...
type Props = {
  ...
  listings: ApartmentListing[]; favoriteIds: string[]; history: SearchHistoryItem[];
...
export function ApartmentHome({ isLoading, error, userName, listings, favoriteIds, history, onStartConversation, onTextSearch, onToggleFavorite, onSignIn, onSignOut }: Props) {
