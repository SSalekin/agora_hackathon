...
- debounced transcript fragments, spoken-number budgets, and cross-turn constraint refinement where the latest value wins
...
6. The first explicit apartment-search request reveals results; later completed turns refine the same search context.
